...
-- Tiempo de generación: 11-12-2025 a las 14:41:12
...
CREATE TABLE `sigi_modulo_formativo` (
  `id` int NOT NULL,
...
CREATE TABLE `sigi_planes_estudio` (
  `id` int NOT NULL,
...
CREATE TABLE `sigi_programa_estudios` (
  `id` int NOT NULL,
...
CREATE TABLE `sigi_unidad_didactica` (
  `id` int NOT NULL,
...
--
-- Indices de la tabla `sigi_modulo_formativo`
--
ALTER TABLE `sigi_modulo_formativo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_modulo_plan` (`id_plan_estudio`);

--
-- Indices de la tabla `sigi_planes_estudio`
--
ALTER TABLE `sigi_planes_estudio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_planes_programa` (`id_programa_estudios`);

--
-- Indices de la tabla `sigi_programa_estudios`
--
ALTER TABLE `sigi_programa_estudios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sigi_semestre`
--
...
--
-- Indices de la tabla `sigi_unidad_didactica`
--
...
--
-- AUTO_INCREMENT de la tabla `sigi_modulo_formativo`
--
ALTER TABLE `sigi_modulo_formativo`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `sigi_planes_estudio`
--
ALTER TABLE `sigi_planes_estudio`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `sigi_programa_estudios`
--
ALTER TABLE `sigi_programa_estudios`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `sigi_semestre`
--
ALTER TABLE `sigi_semestre`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `sigi_unidad_didactica`
--
ALTER TABLE `sigi_unidad_didactica`
