<?php
$conexion =  new mysqli("localhost", "root","root" ,"sigo_huanta");
if ($conexion->connect_errno) {
    echo "Fallo al conectar a MySQL; (" . $conexion->connec_errno .") " .$conexion->connec_error;
